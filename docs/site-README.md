...
`showPageCard()`, with no × (`.pagecard`) and a navy background with interlocking light-blue square double spirals in the theme's colours behind it (`.pagebg`) where a card
